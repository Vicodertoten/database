...
La charte canonique v1 (`docs/06_charte_canonique_v1.md`) formalise la politique. Cet ADR transforme cette politique en spécification d’implémentation.
...
- charte stable publiée (`docs/06_charte_canonique_v1.md`)
