...
def test_pipeline_produces_reproducible_output(
    ...
    assert export_payload["schema_version"] == "database.schema.v16"
    ...
    assert normalized_payload["schema_version"] == "database.schema.v16"
...
def test_pipeline_rejects_invalid_export_bundle(
    ...
    def fake_build_export_bundle(**kwargs):
        del kwargs
        return {
            "schema_version": "database.schema.v16",
